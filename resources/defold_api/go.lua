...
---@return number|boolean|hash|url|vector3|vector4|quaternion|resource_data value the value of the specified property
...
---@param value number|boolean|hash|url|vector3|vector4|quaternion|resource_data the value to set
---@param options? table optional options table
