...
---@return { name:string, address?:string, mac?:string, up:boolean, running:boolean } ifaddrs an array of tables. Each table entry contain the following fields:
---
---`name`
...
---@param options? { ignore_secure?:boolean } optional options table
---- ignore_secure boolean this flag ignores values might be secured by OS e.g. `device_ident`
---@return { device_model?:string, manufacturer?:string, system_name:string, system_version:string, api_version:string, language:string, device_language:string, territory:string, gmt_offset:number, device_ident?:string, user_agent?:string } sys_info table with system information in the following fields:
---
---`device_model`
...
---
---@return number handle a handle to the request
...
---@param attributes? { target?:string, name?:string } table with attributes
---`target`
