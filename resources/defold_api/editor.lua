...
---array schema
---@param opts { item:editor.schema, default?:any[], scope?:string } Required opts: item schemaarray item schema  Optional opts: default item[]default valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
function editor.prefs.schema.array(opts) end

---boolean schema
---@param opts? { default?:boolean, scope?:string } Optional opts: default booleandefault valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
...
---integer schema
---@param opts? { default?:integer, scope?:string } Optional opts: default integerdefault valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
...
---@param opts? { default?:string, scope?:string } Optional opts: default stringdefault valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
function editor.prefs.schema.keyword(opts) end

---floating-point number schema
---@param opts? { default?:number, scope?:string } Optional opts: default numberdefault valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
...
---@param opts { key:editor.schema, val:editor.schema, default?:table, scope?:string } Required opts: key schematable key schemaval schematable value schema  Optional opts: default tabledefault valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
...
---@param opts { item:editor.schema, default?:table<editor.schema, boolean>, scope?:string } Required opts: item schemaset item schema  Optional opts: default table<item, true>default valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
...
---@param opts { items:editor.schema[], default?:any[], scope?:string } Required opts: items schema[]schemas for the items  Optional opts: default any[]default valuescope stringpreference scope; either: editor.prefs.SCOPE.GLOBAL: same preference value is used in every project on this computereditor.prefs.SCOPE.PROJECT: a separate preference value per project
---@return editor.schema value Prefs schema
...
---@param options? { decode_null_as_userdata?:boolean } A table with the following keys:all booleanif true, decodes all json values in a string and returns an array
