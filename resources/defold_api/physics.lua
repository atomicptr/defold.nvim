...
---@return { type?:number, diameter?:number, dimensions?:vector3, height?:number } table A table containing meta data about the physics shape
---
---`type`
...
---@param url string|hash|url the collision object.
---@param shape string|hash the name of the shape to get data for.
---@param table { diameter?:number, dimensions?:vector3, height?:number } the shape data to update the shape with.
